...
import { MapPinIcon, Search, PlusIcon, PencilIcon, TrashIcon, GlobeIcon } from "lucide-react"
import { getLocations, createLocation, updateLocation, deleteLocation } from "../../api/mock/locations"
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Manage geographic locations and destinations</p>
        </div>
        <button
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">{locations.reduce((sum, l) => sum + l.hotelCount, 0)}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {loading ? (
          ...
          <div className="col-span-full text-center text-gray-500 py-8">No locations found</div>
        ) : (
            ...
            <div key={location.id} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                <div className="text-sm text-gray-600">
                  <span className="font-medium text-gray-900">{location.hotelCount}</span> hotels
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={() => handleDeleteClick(location)} className="text-red-600 hover:text-red-800 p-1">
      ...
      <Modal isOpen={isDeleteModalOpen} onClose={() => setIsDeleteModalOpen(false)} title="Delete Location">
